...
{
    public class SqliteStorageTests(SqliteStorageFixture fixture, ITestOutputHelper output) : StorageBaseTest(fixture, output), IClassFixture<SqliteStorageFixture>
    {
    }
