...
namespace StackExchange.Profiling.Tests
{
    ...
    [XunitTestCaseDiscoverer("StackExchange.Profiling.Tests.FactDiscoverer", "MiniProfiler.Tests.Providers")]
    ...
    /// </summary>
    [AttributeUsage(AttributeTargets.Method, AllowMultiple = false)]
    [XunitTestCaseDiscoverer("StackExchange.Profiling.Tests.TheoryDiscoverer", "MiniProfiler.Tests.Providers")]
    ...
    internal static class XUnitExtensions
    {
        internal static string StripName(this string name) =>
            name.Replace("StackExchange.Profiling.Tests.", "");
