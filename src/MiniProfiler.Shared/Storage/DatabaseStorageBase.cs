...
namespace StackExchange.Profiling.Storage
{
    ...
    public abstract class DatabaseStorageBase : IAsyncStorage, IDatabaseStorageConnectable
    {
        ...
        /// <summary>
        /// Replace pattern fox index and constraint identifiers.
        /// </summary>
        protected readonly string IndexNameWrongSymbolsReplacePattern = @"([+*\-\@#!$~%^&().\[\]]){1,}";
        ...
        private List<string> _schemaNameCreationScripts;

        /// <summary>
        /// The schema name creation scripts for this database storage.
        /// Generated by the <see cref="GetSchemaNameCreationScripts"/> implemented by the provider.
        /// </summary>
        public List<string> SchemaNameCreationScripts(IEnumerable<string> schemaNames) => _schemaNameCreationScripts ??= GetSchemaNameCreationScripts(schemaNames).ToList();
        ...
        /// <summary>
        /// Creates needed schema names. Run this once on your database before table creation scripts if needed.
        /// </summary>
        /// <remarks>
        /// Works in SQL server and <c>sqlite</c> (with documented removals).
        /// </remarks>
        /// <param name="schemaNames">Schema names to create.</param>
        protected abstract IEnumerable<string> GetSchemaNameCreationScripts(IEnumerable<string> schemaNames);
